        ...
        <div className="w-full h-auto px-10 md:px-40 lg:px-40 py-20 ">
            <div className="w-full mt-20 flex flex-col lg:flex-row justify-between items-center gap-[100px]">
                <div className="w-full lg:w-[50%] text-center lg:text-left">
                    <h1 className="font-[600] w-full lg:w-[500px] text-[#ffffff] font-poppins lg:text-[60px] text-[40px] lg:text-start text-center">
                ...
                <div className="w-full lg:w-[50%]">
                    <img src={FirstImage} alt="img" className="w-full" />
                </div>
            </div>
        </div>
    );
